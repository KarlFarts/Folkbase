...
export async function batchLinkNoteToEntities(accessToken, sheetId, noteId, entityLinks) {
  ...
  for (const contactId of contactIds) {
    try {
      ...
      results.contacts.push({ contactId, ...result });
    } catch (error) {
      results.contacts.push({ contactId, success: false, error: error.message });
    }
  }
  ...
  for (const eventId of eventIds) {
    try {
      ...
      results.events.push({ eventId, ...result });
    } catch (error) {
      results.events.push({ eventId, success: false, error: error.message });
    }
  }
  ...
  for (const listId of listIds) {
    try {
      ...
      results.lists.push({ listId, ...result });
    } catch (error) {
      results.lists.push({ listId, success: false, error: error.message });
    }
  }
  ...
  for (const taskId of taskIds) {
    try {
      ...
      results.tasks.push({ taskId, ...result });
    } catch (error) {
      results.tasks.push({ taskId, success: false, error: error.message });
    }
  }
